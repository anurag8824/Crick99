                  ...
                  <li>
                    <span style={{ color: "#000" }}>
                      <strong>
                        ...
                        which is complete, the coins will be more or less. And
                        the players who are where they are after the result it
                        will be considered.
                      </strong>
                    </span>
                  </li>
                  ...
                  <li>
                    <span style={{ color: "#000" }}>
                      <strong>
                        ...
                        running, their final result will be given on their runs
                      </strong>
                    </span>
                  </li>
                </ul>
                  ...
                  <li>
                    <span style={{ color: "#000" }}>
                      <strong>
                        ...
                        considered as 0 (Zero) and the same will be given as
                        result
                      </strong>
                    </span>
                  </li>
                  ...
                  <li>
                    <span style={{ color: "#000" }}>
                      <strong>
                        ...
                        final over then result will be given even if he haven't

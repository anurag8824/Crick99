...
//   const [currentItems, setCurrentItems] = useState<any>([])
//   const [currentItems22, setCurrentItems22] = useState<any>([])
...
//       .getAccountList22()
//       .then((res) => {
//         console.log(res,"new 22,djfnjdnfgdf")
//         setCurrentItems22(res.data.data)
...
//     const achtml =
//       currentItems &&
//       currentItems22?.reverse()?.map((stmt: any, index: number) => {

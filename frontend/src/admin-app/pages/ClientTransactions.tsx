...
const ClientTransactions = () => {
  return (
    <div className="container-fluid ">
          ...
          <div className="ant-row">
            <div className="ant-card ant-card-bordered gx-card">
              <div className="ant-card-body">
                <div style={{background:"pink"}}  className="bg-grey mb-2 flex item-center justify-between px-5 py-3 gx-bg-flex">
      ...
      {/* Ledger Type */}
      <div className="col-12 col-md-6 col-lg-4">
        <label htmlFor="advanced_search_ledgerType" className="form-label">
          Ledger Type
        </label>
        <select id="advanced_search_ledgerType" className="form-select">

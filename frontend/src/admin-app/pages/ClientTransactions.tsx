                  ...
                  <form id="advanced_search" className="row g-3">
                    ...
                    <div className="col-12 col-md-6 col-lg-4">
                      ...
                      >
                        ...
                        <option value="cash">Payment Diya</option>
                        <option value="card">Payment Liya</option>
                      </select>
                    </div>
...
<div className="rows d-flex g-2 p-3 mb-3 border rounded bg-light">
  <div className="col-4 col-md-4">
    <span className="text-dangedr fw-bold">Dena {selectedClient?.amount.toFixed()}</span>
  </div>
  <div className="col-4 col-md-4">
    <span className="text-succedss fw-bold">Lena {selectedClient?.final.toFixed(2)}</span>
  </div>
  <div className="col-4 col-md-4">
    <span className="text-dangerd fw-bold">Balance {(Math.abs(selectedClient?.amount) + Math.abs(selectedClient?.settled)).toFixed()}</span>
  </div>
</div>
